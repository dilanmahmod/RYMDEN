describe('Logga in som privatkund', () => {
  it('Användare ska kunna se Logga in som privatkund och fylla i e-post och lösenord', () => {
      cy.visit('http://127.0.0.1:5501/privatkundLoggin.html');
      cy.contains('Logga in som privatkund').should('be.visible');
...
describe('Registreringslänk', () => {
  it('Användare ska kunna se Är du inte kund? och klicka på Skapa konto för att navigera till Registreringssida', () => {
      ...
      cy.url().should('include', 'http://127.0.0.1:5501/registrering.html');
  });
});
